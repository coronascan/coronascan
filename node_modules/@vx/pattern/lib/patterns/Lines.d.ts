...
export default function PatternLines({ id, width, height, stroke, strokeWidth, strokeDasharray, strokeLinecap, shapeRendering, orientation, background, className, }: PatternLinesProps): JSX.Element;
