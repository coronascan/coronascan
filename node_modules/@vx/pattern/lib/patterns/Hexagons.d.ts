...
export default function PatternHexagons({ id, height, fill, stroke, strokeWidth, strokeDasharray, strokeLinecap, shapeRendering, background, className, size, }: PatternHexagonsProps): JSX.Element;
