...
export default function PatternCircles({ id, width, height, radius, fill, stroke, strokeWidth, strokeDasharray, background, complement, className, }: PatternCirclesProps): JSX.Element;
