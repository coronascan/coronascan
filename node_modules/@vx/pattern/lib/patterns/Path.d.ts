...
export default function PatternPath({ id, width, height, path, fill, stroke, strokeWidth, strokeDasharray, strokeLinecap, shapeRendering, background, className, }: PathProps): JSX.Element;
export {};
