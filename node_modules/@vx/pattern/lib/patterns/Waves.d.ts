...
export default function PatternWaves({ id, width, height, fill, stroke, strokeWidth, strokeDasharray, strokeLinecap, shapeRendering, background, className, }: PatternWavesProps): JSX.Element;
