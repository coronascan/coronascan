            ...
            <Row>
              <Col md={12} lg={6}>
                <ul className="warning__step">
                  ...
                  <li className="warning__style_none">
                    *자가격리 수칙 위반 시 1년 이하 징역 혹은 1천만원 이하 벌금
                  </li>
                  <li className="warning__style_none">
                    **능동감시 적용 대상 : 외교·공무·협정 등의 용무 비자(A1, A2,
                    A3) 출국 국가의 한국대사관에서 중요한 사업상 목적, 국제대회
                    등 학술적 목적, 기타 공익적, 인도적 목적 등으로 방문타당성이
                    인정되어 '자가격리면제서'를 사전에 발급받은 경우
                  </li>
                  <li className="warning__style_none">
              ...
              <Col>
                <ul className="warning__step">
                  ...
                  <li>
                    04.13 미국발 입국자에 대해 자가격리 후 3일 내 코로나19 진단
                    전수검사 실시
                  </li>
                  <li>
