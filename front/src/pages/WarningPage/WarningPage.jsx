            ...
            <Row>
              <Col sm>
                <ul className="warning__step">
                  ...
                  <li>2020-03-18 전 국가·지역 여행경보 1단계(여행유의) 발령</li>
                  <li>2020-03-16 유럽 지역 여행경보 2단계(황색경보, 여행자제) 발령</li>
                  <li>2020-03-11 이탈리아 전역 여행경보 1단계(남색경보, 여행유의) 추가 발령</li>
                  <li>2020-03-09 이탈리아 피에몬테주 및 마르케주에 여행경보 2단계 (황색경보) 발령</li>
                  <li>2020-03-08 일본 전 지역에 여행경보 2단계(황색경보, 여행자제)로 상향 조정</li>
